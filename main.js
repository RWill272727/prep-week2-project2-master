...
var array1 = [];
array1.push("apple","banana","carrot","dinner");
document.getElementById("q1").innerHTML = array1;

// 2. Add an additional item to the beginning of your array.

array1.unshift("animal");
...
array1.splice(2,0,"potato","orange");
...
document.getElementById("q5").innerHTML = "The current length of the array is " + array1.length;
